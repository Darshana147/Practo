...
class MedicineFavoriteListRecyclerAdapter(var context: Context, var medWishList:ArrayList<Medicine>):RecyclerView.Adapter<MedicineFavoriteListRecyclerAdapter.MyViewHolder>() {
