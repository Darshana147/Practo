...
class MedicineCartRecyclerAdaptor(var context: Context, var cartItemList:ArrayList<MedicineCartItem>, val listener:OnChangeCartItemQtyListener):RecyclerView.Adapter<MedicineCartRecyclerAdaptor.MyViewHolder>(){
